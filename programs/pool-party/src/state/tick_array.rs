...
use crate::errors::ErrorCode::InvalidTickArray;

pub trait TickArrayStateExt {
...
impl TickArrayStateExt for TickArrayState {
    fn tick_count(tick_spacing: u16) -> i32 {
    ...
    fn get_tick_offset_in_array(
        ...
        let check_start_tick_index = TickArrayState::get_array_start_index(
            tick_index,
            tick_spacing
        );
        require_eq!(check_start_tick_index, start_tick_index, InvalidTickArray);
